...
class Save_Model(tf.keras.callbacks.Callback):
    def __init__(self, gen, dis, dataSetConfig, mode='min', save_weights_only=False):
        ...
        copytree('../model', f'./log/{startingDate}/model')
        copytree('../utlis', f'./log/{startingDate}/utlis')

        copyfile('../main.py', f'./log/main.py')
